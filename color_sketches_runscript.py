...
checkpoint_output='output_checkpoint/colorsketches-iter-%d-batchsize-%d-lr-%f-content-%d_%%s.jpg' % (iterations, batch_size, learning_rate, content_weight)
output='output/colorsketches-iter-%d-batchsize-%d-lr-%f-content-%d.jpg' % (iterations, batch_size, learning_rate, content_weight)
...
os.system('python ~/PycharmProjects/my-neural-style/color_sketches.py --learning_rate=%f --iterations=%d --batch_size=%d --content_weight=%d --checkpoint_iterations=%d --width=%d --height=%d --checkpoint_output=%s --test_img=%s --output=%s --model_save_dir=%s --print_iterations=%d %s %s'
