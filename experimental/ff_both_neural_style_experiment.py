...
import ff_both_net_experimental
...
def build_parser():
    ...
    parser.add_argument('--style_folder', dest='style_folder',
                        ...
                        default='/home/ubuntu/pixiv/pixiv_training_filtered/')
...
def main():
    ...
    if options.content_img_style_weight_mask:
        # Resize to the same shape as content image because they should be concatenated together.
    ...
    for iteration, image in ff_both_net_experimental.style_synthesis_net(
