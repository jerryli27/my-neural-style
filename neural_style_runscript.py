...
iterations=1000
batch_size=1
style_weight=100 if not use_mrf else 3 # 100 for old gram loss works. The weight for mrf varies from picture to picture.
content_weight=5
