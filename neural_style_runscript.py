...
checkpoint_output='output_checkpoint/%s-%s-iter-%d-batchsize-%d-lr-%f-use_mrf-%s-use_masks-%s-style-%d-content-%d_%%s.jpg' % (contents_name, style_name, iterations, batch_size, learning_rate, str(use_mrf), str(use_semantic_masks), style_weight, content_weight)
output='output/%s-%s-iter-%d-batchsize-%d-lr-%f-use_mrf-%s-use_masks-%s-style-%d-content-%d.jpg' % (contents_name, style_name, iterations, batch_size, learning_rate, str(use_mrf), str(use_semantic_masks), style_weight, content_weight)
